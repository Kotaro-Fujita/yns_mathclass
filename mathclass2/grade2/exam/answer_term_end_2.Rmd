...
\begin{ansbox}
\pbox{1}[height=70mm]
\ptxt[above=25mm]{1}{l}{$\triangle$ACDと$\triangle$DBAにおいて}
\ptxt[below=18mm]{1}{l}{合同な図形の対応する辺の長さは等しいから}
\ptxt[below=25mm]{1}{l}{AC $=$ DB}
\pbox{1}
\ptxt{2}{l}{記号\hspace{5em}見直した内容}
\end{ansbox}
