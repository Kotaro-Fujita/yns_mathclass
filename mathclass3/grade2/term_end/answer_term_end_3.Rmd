...
\begin{ansbox}
\pbox[2]{4}
\ptxt{1}{l}{$x = $\hspace{\fill} $y = $\hspace{\fill}}
\ptxt{2}{l}{$x = $\hspace{\fill} $y = $\hspace{\fill}}
\ptxt{3}{l}{$x = $\hspace{\fill} $y = $\hspace{\fill}}
\ptxt{4}{l}{$x = $\hspace{\fill} $y = $\hspace{\fill}}
\end{ansbox}
...
\pbox{1}
\ptxt{3}{l}{中央値 \hspace{\fill} 四分位範囲 \hspace{\fill} 範囲 \hspace{\fill}}
\pbox{2}
\end{ansbox}
