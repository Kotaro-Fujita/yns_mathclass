...
\pbox{1}
\ptxt{1}{l}{逆}
\ptxt{2}{l}{正しい・正しくない \hspace{1em} 反例}
\sxchg{(3)}{\mbox{(2)}}
\pbox{1}
\sxchg{(4)}{\mbox{　}}
\pbox{1}
\ptxt{3}{l}{逆}
\ptxt{4}{l}{正しい・正しくない \hspace{1em} 反例}
\sxchg{(5)}{\mbox{(3)}}
\pbox{1}
\sxchg{(6)}{\mbox{　}}
\pbox{1}
\ptxt{5}{l}{逆}
\ptxt{6}{l}{正しい・正しくない \hspace{1em} 反例}
\sxchg{(7)}{\mbox{(4)}}
\pbox{1}
\sxchg{(8)}{\mbox{　}}
\pbox{1}
\ptxt{7}{l}{逆}
\ptxt{8}{l}{正しい・正しくない \hspace{1em} 反例}
\sxchg{(9)}{\mbox{(5)}}
\pbox{1}
\sxchg{(10)}{\mbox{　}}
\pbox{1}
\ptxt{9}{l}{逆}
\ptxt{10}{l}{正しい・正しくない \hspace{1em} 反例}
\end{ansbox}
...
\begin{ansbox}
\pbox*{1}
\ptxt{1}{l}{（組）\hspace{8em}（合同条件）}
\pbox*{1}
\ptxt{2}{l}{（組）\hspace{8em}（合同条件）}
\end{ansbox}
