...
\begin{ansbox}
\pbox{1}
\ptxt{1}{l}{\maru{ア}（名前） \hspace{17em} （何面体）}
\sxchg{(2)}{\mbox{　}}
\pbox{1}
\ptxt{2}{l}{\maru{ウ}（名前） \hspace{17em} （何面体）}
\sxchg{(3)}{\mbox{　}}
\pbox{1}
\ptxt{3}{l}{\maru{エ}（名前） \hspace{17em} （何面体）}
\sxchg{(4)}{(2)}
\pbox{1}
\ptxt{4}{l}{\maru{オ}（名前） \hspace{17em} （側面）}
\sxchg{(5)}{\mbox{　}}
\pbox{1}
\ptxt{5}{l}{\maru{カ}（名前） \hspace{17em} （側面）}
\sxchg{(6)}{(3)}
\pbox{1}
\end{ansbox}
...
\begin{ansbox}[height=55mm]
\pbox[2]{2}
\ptxt{1}{c}{%
\begin{figurehere}%
\includegraphics[width=50mm]{media/tu4.png}%
\end{figurehere}%
}
\ptxt{2}{c}{%
\begin{figurehere}%
\includegraphics[width=50mm]{media/image3.png}%
\end{figurehere}%
}
\end{ansbox}
